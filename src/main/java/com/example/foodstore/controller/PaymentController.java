...
public class PaymentController {
    ...
    private final String callback_url = "https://freshfoodute.onrender.com/api/payment/callback";
    ...
    private final String vnp_ReturnUrl = "https://freshfoodute.onrender.com/api/payment/vnpay-ipn";
